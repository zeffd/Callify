...
public class Choose_Tracking_Local_No_Adapter extends RecyclerView.Adapter<Choose_Tracking_Local_No_Adapter.ViewHolder> {
    Context context;
    List<String> rowItems;

    public Choose_Tracking_Local_No_Adapter(Context context, List<String> rowItem) {
