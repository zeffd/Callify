...
public class Add_Recent_Calls_Adapter extends RecyclerView.Adapter<Add_Recent_Calls_Adapter.ViewHolder> {
    Context context;
    private List<BeanNameCont> rowItems;

    public Add_Recent_Calls_Adapter(Context context, List<BeanNameCont> rowItems) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.recent_calls_row, parent, false));
    }
